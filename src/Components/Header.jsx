      ...
      <div className='flex justify-between items-center max-w-6xl mx-auto p-3'>
        <Link to='/'>
          <h1 className='font-bold text-sm sm:text-xl flex flex-wrap'>
            ...
            <span className='text-slate-800'>Dekho</span>
          </h1>
        </Link>
          ...
          <Link to='/profile'>
            {currentUser ? (
              <img
                ...
                src={currentUser.avatar || "https://e7.pngegg.com/pngimages/799/987/png-clipart-computer-icons-avatar-icon-design-avatar-heroes-computer-wallpaper-thumbnail.png"}
                alt='profile'
              />
            ) : (
